...
class _HomeScreenState extends State<HomeScreen>{
  ...
  String url="https://lit-hamlet-76910.herokuapp.com/quiz/PlayerQuiz/5/";
  _fetchQuizs() async{
    setState((){
      isLoading = true;
    });
  ...
  Widget build(BuildContext context){
    ...
    child: SafeArea(
      child: Scaffold(
        key:_scaffoldKey,
        appBar:AppBar(
          title:Text('Football Player Quiz'),
          ...
          Text('이 퀴즈는 축구선수 인지도 조사\n퀴즈 입니다.',textAlign:TextAlign.center,),
          //Padding(padding:EdgeInsets.all(width*0.5),),
          _buildStep(width,'1.랜덤으로 나오는 퀴즈 5개를 풀어보세요.'),
